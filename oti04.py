...
#Starting guess
i=47.5
xyz_start= [i,i,i,i,i,i,i,i,i,i,i,i,i,i,i]
...
#Restricoes de limite de escoamento (INEQUACOES)
def restricao1(x):
    return Tensao_escoamento-fem01(x)[0]*FS

def restricao2(x):
    return Tensao_escoamento-fem02(x)[0]*FS

def restricao21(x):
    return Tensao_escoamento-fem03(x)[0]*FS

#Deslocamento
deslocamento=5 #era 5
def restricao3(x):
    return deslocamento-fem01(x)[1]

def restricao4(x):
    return deslocamento-fem02(x)[1]

def restricao22(x):
    return deslocamento-fem03(x)[1]

#Rotacao
#rot=0.088
rot=0.09
def restricao5(x):
    return rot-fem01(x)[2]

def restricao6(x):
    return rot-fem02(x)[2]

def restricao23(x):
    return rot-fem03(x)[2]
...
cons11={'type':'ineq','fun':lambda xyz: restricao11(xyz)}
...
cons20={'type':'eq', 'fun': lambda xyz: restricao20(xyz)}

cons21={'type':'ineq', 'fun': lambda xyz: restricao21(xyz)}
cons22={'type':'ineq', 'fun': lambda xyz: restricao22(xyz)}
cons23={'type':'ineq', 'fun': lambda xyz: restricao23(xyz)}
cons24={'type':'ineq', 'fun': lambda xyz: restricao24(xyz)}


con1 = [cons1, cons2, cons3, cons4, cons5, cons6, cons7, cons8, cons9, cons10, cons11, cons12, cons13, cons14, cons15, cons16, cons17, cons18, cons19, cons20]
con2 = [cons1, cons2,cons3, cons4, cons5, cons6, cons7, cons8, cons9, cons10, cons11, cons12, cons13, cons14, cons15, cons16, cons17, cons18, cons19, cons20, cons21, cons22, cons23, cons24 ]
...
result=minimize(objective, xyz_start, method='SLSQP',bounds=bnds, options={'ftol': 1e-3,"disp": True,"maxiter":20000}, constraints=con2)
print(result)
